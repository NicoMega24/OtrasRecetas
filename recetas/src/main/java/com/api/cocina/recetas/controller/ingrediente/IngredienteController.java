...
public class IngredienteController {
    ...
    public ResponseEntity<IngredienteDto> obtenerIngrediente(@PathVariable UUID id) {
        try {
    ...
    public ResponseEntity<IngredienteDto> actualizarIngrediente(@PathVariable UUID id, @RequestBody IngredienteDto ingredienteDto) {
        try {
    ...
    public ResponseEntity<Void> eliminarIngrediente(@PathVariable UUID id) {
        try {
