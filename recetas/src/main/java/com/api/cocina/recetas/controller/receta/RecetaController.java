...
public class RecetaController {
    ...
    public ResponseEntity<RecetaDto> obtenerReceta(@PathVariable UUID id) {
        try {
    ...
    public ResponseEntity<RecetaDto> actualizarReceta(@PathVariable UUID id, @RequestBody RecetaDto receta) {
        try {
    ...
    public ResponseEntity<List<IngredienteDto>> obtenerIngredientesDeReceta(@PathVariable UUID id) {
    ...
    public ResponseEntity<Integer> obtenerTiempoPreparacionDeReceta(@PathVariable UUID id) {
